...
v1_vec = arange(-380,-340,0.06)     #V_g
v2_vec = arange(-800,800,5)  #V_sd 
...
data = qt.Data(name='industrial sample 17-18_diamond')
...
for v1 in v1_vec:
    ...
    for v2 in v2_vec:
        ...
        # readout
        result = dmm.get_readval()/gain*1e9
