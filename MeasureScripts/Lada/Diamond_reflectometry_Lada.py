...
file_name = '5-24 gate vs gate 80uV By=2T -35dBm 100Hz zoomin another even'
...
v1_vec = arange(2124,2135,0.2)     #V_g
v2_vec = arange(2360,2320,-0.2)  #V_sd 
...
plot3d = qt.Plot3D(data, name='Plot3Dx6', coorddims=(1,0), valdim=2, style='image') #flipped coordims that it plots correctly
