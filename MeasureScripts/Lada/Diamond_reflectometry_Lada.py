...
file_name = '5-24 gate vs gate 80uV -35dBm 100Hz zoomin pulsing 0.7ms -1000ch1 +1200ch2'
...
v1_vec = arange(2115,2150,0.25)     #V_g
v2_vec = arange(2375,2325,-0.25)  #V_sd 
...
plot3d = qt.Plot3D(data, name='plot14', coorddims=(1,0), valdim=2, style='image') #flipped coordims that it plots correctly
