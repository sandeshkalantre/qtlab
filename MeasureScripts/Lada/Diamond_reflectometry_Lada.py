...
file_name = '5-24 gate vs gate 80uV -35dBm 100Hz pulsing +-300 -+ 360 inverted times'
...
v1_vec = arange(2174,2190,0.2)     #V_g
v2_vec = arange(2240,2220,-0.2)  #V_sd 
...
plot3d = qt.Plot3D(data, name='p8', coorddims=(1,0), valdim=2, style='image') #flipped coordims that it plots correctly
