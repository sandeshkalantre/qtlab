...
data.add_value(' Reflection [Arb. U.]')      # Underline makes the next letter as index
...
for v in v_vec:
    ...
    if leak_test:
        plot2d_lockin.update()   # If leak_test is True update every point 
    elif not bool(mod(v,10)):    
        plot2d_lockin.update()   # Update every 10 points
