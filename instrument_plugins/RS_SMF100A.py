...
class RS_SMF100A(Instrument):
    '''
    This is the python driver for the Rohde & Schwarz SMF100A
    signal generator

    Usage:
    Initialize with
    <name> = instruments.create('name', 'RS_SMF100A', address='<GPIB address>',
        reset=<bool>)
    '''

    def __init__(self, name, address, reset=False):
        '''
        Initializes the SMF_100A, and communicates with the wrapper.
